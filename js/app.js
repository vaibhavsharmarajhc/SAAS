      ...
      html: `
        <div style="width: 100%; font-family: sans-serif; display: flex; gap: 2rem; flex-wrap: wrap; text-align: left;">
          ...
          <div style="flex: 1.2; min-width: 260px; display: flex; flex-direction: column; justify-content: center;">
            <div style="font-weight: 700; color: #fff; margin-bottom: 0.75rem; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.5px; border-bottom: 1px solid rgba(255,255,255,0.06); padding-bottom: 0.4rem;">Active Case Briefs</div>
